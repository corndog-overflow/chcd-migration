INSERT INTO CorporateEntities_PartOf_CorporateEntities (entity_from_id, entity_to_id, start_day, start_month,
...
INSERT INTO People_InvolvedWith_Publications (entity_from_id, entity_to_id, start_day, start_month, start_year, end_day,
                                              end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
       r.start_month,
...
INSERT INTO Institutions_PartOf_CorporateEntities (entity_from_id, entity_to_id, start_day, start_month, start_year,
                                                   end_day, end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
       r.start_month,
...
INSERT INTO Events_PartOf_CorporateEntities (entity_from_id, entity_to_id, start_day, start_month, start_year, end_day,
                                             end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
INSERT INTO People_PartOf_CorporateEntities (entity_from_id, entity_to_id, start_day, start_month, start_year, end_day,
                                             end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
INSERT INTO People_PresentAt_Events (entity_from_id, entity_to_id, start_day, start_month, start_year, end_day,
                                     end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
INSERT INTO People_PresentAt_Institutions (entity_from_id, entity_to_id, start_day, start_month, start_year, end_day,
                                           end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
INSERT INTO People_PresentAt_GeneralAreas (entity_from_id, entity_to_id, start_day, start_month, start_year, end_day,
                                           end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
INSERT INTO People_RelatedTo_People (entity_from_id, entity_to_id, start_day, start_month, start_year, end_day,
                                     end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
INSERT INTO Institutions_LinkedTo_Events (entity_from_id, entity_to_id, start_day, start_month, start_year, end_day,
                                          end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
INSERT INTO Events_LinkedTo_Events (entity_from_id, entity_to_id, start_day, start_month, start_year, end_day,
                                    end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
INSERT INTO Institutions_LinkedTo_Institutions (entity_from_id, entity_to_id, start_day, start_month, start_year,
                                                end_day, end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
INSERT INTO CorporateEntities_InvolvedWith_Publications (entity_from_id, entity_to_id, start_day, start_month,
                                                         start_year, end_day, end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
INSERT INTO Publications_InvolvedWith_Publications (entity_from_id, entity_to_id, start_day, start_month, start_year,
                                                    end_day, end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
INSERT INTO Events_InvolvedWith_Publications (entity_from_id, entity_to_id, start_day, start_month, start_year, end_day,
                                              end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
INSERT INTO Institutions_InvolvedWith_Publications (entity_from_id, entity_to_id, start_day, start_month, start_year,
                                                    end_day, end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
INSERT INTO Publications_InvolvedWith_GeneralAreas (entity_from_id, entity_to_id, start_day, start_month, start_year,
                                                    end_day, end_month, end_year, notes, source)
SELECT nf.chcd_id,
       nt.chcd_id,
       r.start_day,
...
FROM temp_relationships r
         ...
         JOIN temp_nodes g ON r.end_id = g.neo4j_id AND
                              g.label in ('Village', 'Township', 'County', 'Prefecture', 'Province', 'Nation');
...
WHERE GeographyNodes.id = n.chcd_id;
